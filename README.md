...
- [`6.0`, `latest` (6.0/Dockerfile)][Latest Dockerfile]
- [`6.0-onbuild` (6.0/onbuild/Dockerfile)](https://github.com/tatsushid/docker-tinycore-node/blob/master/6.0/onbuild/Dockerfile)
...
[Latest Dockerfile]: https://github.com/tatsushid/docker-tinycore-node/blob/master/6.0/Dockerfile
